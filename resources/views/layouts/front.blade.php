    ...
    <div class="main-wrapper">
                    ...
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <div class="dropdown">
                            <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                aria-expanded="false"
                                style="color: {{ $opciones['color_elementos_menu'] }} !IMPORTANT; font-family: {{ $opciones['tipografia1'] }} !IMPORTANT; margin-bottom: 1em; margin-right: 2em">
                                COLECCIONES
                            </button>

                            <ul class="dropdown-menu"
                                style="background-color: {{ $opciones['color_nav'] }}; font-family: {{ $opciones['tipografia1'] }} !IMPORTANT">
                                ...
                                @foreach ($categoriasList as $cat)
                                    @if (isset($categoria))
                                        ...
                                        @else
                                            <li class="nav-item">
                                                <a class="nav-link"
                                                    href="/categoria/{{ $cat->id }}">{{ $cat->name }}</a>
                                            </li>
                                        @endif
                                    @else
                                        <li class="nav-item">
                            ...
                            <form action="{{ route('productoPorCategoria', [$categoria->id ?? '']) }}" action="GET">
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-light" type="button" onclick="showInfoMessage()"
                                        style="font-size: 22px; border-left: 2px solid #000;">
                                        ⓘ
                                    </button>
                                </div>
                            </form>
        ...
        <footer class="footer">
            <div class="row align-items-center" style="font-family: {{ $opciones['tipografia1'] }}">
                <div class="col-lg-4 text-lg-start"><b>Si estás interesado en exponer tu arte online contáctanos: <br>
                        <div class="colores" style="color: blue">juan.baronviciana@gmail.com -
                            josemanuelgallurt24@gmail.com
                    </b></div>
            </div>
            <div class="col-lg-4 my-3 my-lg-0">
                <a rel="license" href="http://creativecommons.org/licenses/by-nc/4.0/"><img
                        alt="Licencia de Creative Commons" style="border-width:0"
                        src="/storage/images/creative_commons.png" /></a>
            </div>
