...
// https://rawgit.com/MrRio/jsPDF/master/docs/index.html
    ...
    function imprimir(json_product, image_id, json_items, category) {
        ...
        */
        ...
        html += '<div class="contenedor" style="width: ' + anchuraFoto + '%; height: ' + alturaFotoCalculada + '%;"><img src="' + document.getElementById(image_id).src + '" style="width: 100%; height: 100%; object-fit: cover;"></div>';
