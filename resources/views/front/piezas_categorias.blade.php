...
@section('content')
    <div id="page-top">
        <section class="page-section mt-3" id="portfolio" style="--paginacion: {{ $opciones['paginacion_color'] }}; ">
                ...
                <div class="grid">
                    ...
                    @if ($todosProductos != null)
                        @foreach ($todosProductos as $key => $producto)
                                ...
                                <div class="portfolio-item">
                                    <a class="portfolio-link" data-bs-toggle="modal" href="#producto{{ $producto->id }}">
                                        <div class="portfolio-hover">
                                            <div class="portfolio-hover-content"><i class="fas fa-circle-info fa-3x"></i>
                                            </div>
                                        </div>
                            ...
                            <div class="portfolio-modal modal fade" id="producto{{ $producto->id }}" tabindex="-1"
                                role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="close-modal" data-bs-dismiss="modal" style="z-index: 99"><svg
                                                id="Layer_1" data-name="Layer 1" viewBox="0 0 579.74 579.74">
                                                <defs>
                                                    <style>
                                                        .cls-1 {
                                                            fill: none;
                                                ...
                                                <line class="cls-1" x1="2.12" y1="2.12" x2="577.62"
                                                    y2="577.62" />
                                                <line class="cls-1" x1="2.12" y1="577.62" x2="577.62"
                                                    y2="2.12" />
                                            </svg></div>
                                        <div class="container">
                                            <div class="row justify-content-center">
                                                <div class="col-lg-12 p-0">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="carousel-sticky">
                                                            ...
                                                            <div class="carousel-wrapper">
                                                                <div id="carouselExampleIndicators{{ $key }}"
                                                                    ...
                                                                    data-bs-ride="true">
                                                                    <h2 class="title text-uppercase pb-4">
                                                                        {{ $producto->name }}
                                                                    </h2>
                                                                    ...
                                                                    <div class="carousel-inner">
                                                                        ...
                                                                        <div class="carousel-item active w-100">
                                                                            ...
                                                                            <div class="d-flex justify-content-center gap-1 mb-3"
                                                                                ...
                                                                                <button
                                                                                    class="btn btn-outline-secondary fa-solid fa-print mt-3"
                                                                                    onclick="imprimir('{{ addslashes(json_encode($producto, JSON_UNESCAPED_UNICODE)) }}', 'mi_imagen{{ $key }}', '{{ addslashes(json_encode($producto->items, JSON_UNESCAPED_UNICODE)) }}', '{{ $producto->categoriaName }}','{{ addslashes(json_encode($opciones)) }}')">
                                                                                    <button
                                                                                        class="btn btn-outline-secondary fa-solid fa-download mt-3"
                                                                                        onclick="download('{{ asset("storage/$producto->id/$producto->image") }}','{{ $producto->image }}', '{{ $producto->name }}', 0)">
                                                                            </div>
                                                                            <!-- Imagen -->
                                                                            ...
                                                                            @if ($producto->image != null)
                                                                                <figure class="img-wrapper"
                                                                                    ...
                                                                                    style="background-image: url('{{ asset("storage/$producto->id/mini_$producto->image") }}')">
                                                                                    <img id="mi_imagen{{ $key }}"
                                                                                        class="center-block"
                                                                                        src='{{ asset("storage/$producto->id/mini_$producto->image") }}'
                                                                                        alt="{{ $producto->image }}"
                                                                                        loading="lazy" />
                                                                            ...
                                                                            @else
                                                                                <i class="fa-solid fa-question"
                                                                                    style="height: 500px; margin-bottom: 32px"></i>
                                                                            @endif
                                                                        ...
                                                                        @foreach ($producto->imagenes as $image)
                                                                            ...
                                                                            <div class="carousel-item">
                                                                                ...
                                                                                <div class="d-flex justify-content-center gap-1 mb-3"
                                                                                    ...
                                                                                    <button
                                                                                        class="btn btn-outline-secondary fa-solid fa-print mt-3"
                                                                                        onclick="imprimir('{{ addslashes(json_encode($producto, JSON_UNESCAPED_UNICODE)) }}', 'img_secundaria_{{ $producto->id }}_{{ $contador }}', '{{ addslashes(json_encode($producto->items, JSON_UNESCAPED_UNICODE)) }}', '{{ $producto->categoriaName }}','{{ addslashes(json_encode($opciones)) }}')">
                                                                                        <button
                                                                                            class="btn btn-outline-secondary fa-solid fa-download mt-3"
                                                                                            onclick="download('{{ asset("storage/$producto->id/$image->image") }}' , '{{ $image->image }}', '{{ $producto->name }}', {{ $contador }})">
                                                                                </div>
                                                                                <!-- Imagen -->
                                                                                <figure class="img-wrapper"
                                                                                    onmousemove="zoom(event)"
                                                                                    ontouchmove="zoom(event)"
                                                                                    style="background-image: url('{{ asset("storage/$producto->id/mini_$image->image") }}')">
                                                                ...
                                                                <div class="flecha"
                                                                    style="background-color:{{ $opciones['color_nav'] }}">
                                                        ...
                                                        <div class='items'
                                                            style="padding-left: 17%; padding-right: 17%; text-align: left">
                                                            @if (count($producto->items) > 0)
                                                                @foreach ($producto->items as $item)
                                                                    <div class="campo">
                                                                        <p
                                                                            style="color:{{ $opciones['color_cat_activa'] }}; font-family:{{ $opciones['tipografia2'] }}">
                                                                ...
                                                                @endforeach
                                                            @else
                                                                <p style="text-align: center">No existen campos
                                                                    registrados para esta pieza</p>
                                                            @endif
                                                            <!--
...
<!-- <script>
    ...
    function imprimir(json_product, image_id, json_items, category) {
        ...
        doc.addFont('/fonts/' + fontName + '.ttf', fontName,
            'normal'); // Es necesario usar una fuente con soporte unicode y poner el archivo ttf en /public/fonts
        doc.setFont(fontName);
        window.html2canvas = html2canvas;

        // Creamos un HTML con el contenido que queremos que tenga el PDF
        var html = "";
        html += '<p style="font-family: ' + fontName + '; font-size: 120%; letter-spacing: 0.1em">' +
            "{{ $opciones['home_titulo'] }}" + ' [' + "{{ $opciones['home_subtitulo'] }}" + ']</p><hr>';
        html += '<p style="font-family: ' + fontName + '; font-size: 140%; letter-spacing: 0.1em">' + product.name +
            '</p>';
        html += '<img src="' + document.getElementById(image_id).src + '" width="100%">';
        for (var i = 0; i < items.length; i++) {
            html += '<p style="font-family: ' + fontName + '; font-size: 120%; letter-spacing: 0.1em;">' + items[i]
                .name + ':';
            html += items[i].pivot.value.replace(/<p>/g, "<p style='font-family: " + fontName +
